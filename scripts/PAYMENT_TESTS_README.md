...
```bash
# Clean payment data
npx tsx scripts/payment-clean.ts --full

# Setup users
npx tsx scripts/payment-setup.ts

# Run individual tests
npx tsx scripts/payment-test-funding.ts
npx tsx scripts/payment-test-flow.ts
npx tsx scripts/payment-test-duplicate.ts
npx tsx scripts/payment-test-ledger.ts
```
